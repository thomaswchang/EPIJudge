...
# [PROBLEM_TYPE=RECURSION] P10.4 PG 141

# Given a list of stars, return the top k closest stars to Earth
...
def find_closest_k_stars(stars: Iterator[Star], k: int) -> List[Star]:
    ...
    #return [star for distance, star in max_heap]
    return [t[1] for t in max_heap]


def find_closest_k_stars_orig(stars: Iterator[Star], k: int) -> List[Star]:
